...
def calculate_shortest_path(star, empty_rows, empty_columns):
...
def solve(filepath):
    ...
    shortest = sum(calculate_shortest_path(star, empty_rows, empty_columns) for star in star_combinations)
    print(shortest)
